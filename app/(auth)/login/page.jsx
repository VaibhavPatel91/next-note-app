...
function LoginPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Set a timeout to remove the token from localStorage after 6 hours (21600000 ms)
      setTimeout(() => {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden z-10 bg-gray-800 p-4 sm:p-8 before:w-24 before:h-24 before:absolute before:bg-purple-600 before:rounded-full before:-z-10 before:blur-2xl after:w-32 after:h-32 after:absolute after:bg-sky-400 after:rounded-full after:-z-10 after:blur-xl after:top-24 after:-right-12">
